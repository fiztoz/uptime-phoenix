...
> **OCI / Argo CD:** published chart is `oci://ghcr.io/fiztoz/charts/uptime-phoenix`
> (no `helm repo add`). Install + Argo CD Application examples:
> [`docs/guides/helm-and-argocd.md`](guides/helm-and-argocd.md).
