...
2. Recheck HEAD before reserving numbers after `043_notification_throttles`. Heartbeat partition expression and rollup auto-increment IDs are preserved; regional readers still mix monitor-wide heartbeat history until they are scoped.
