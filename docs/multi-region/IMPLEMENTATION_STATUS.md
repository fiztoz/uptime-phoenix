...
4. Integrate shared retry/condition/maintenance evaluation with regional commit. Prove T01/T02/T24/T31/T33 against real persistence, not just the current pure-policy tests. T03 is covered by `037_probe_heartbeat`. Current overall ANY/ALL readers exist; update all UNKNOWN consumers before emitting the new status on existing routes. Incident/delivery rows are stored but not wired into the existing dispatcher.
