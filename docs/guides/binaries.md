...
Release: [v0.2.1](https://github.com/fiztoz/uptime-phoenix/releases/tag/v0.2.1)
...
### Download example (Linux amd64, v0.2.1)
...
./uptime-phoenix-api_0.2.1_linux_amd64
...
./uptime-phoenix-worker_0.2.1_linux_amd64
```
...
./uptime-phoenix-config_0.2.1_linux_amd64 --help

# Kuma import helper
./uptime-phoenix-kuma-import_0.2.1_linux_amd64 --help
```
