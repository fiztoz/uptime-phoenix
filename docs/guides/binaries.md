...
Release: [v0.1.0](https://github.com/fiztoz/uptime-phoenix/releases/tag/v0.1.0)
...
### Download example (Linux amd64, v0.1.0)
...
./uptime-phoenix-api_0.1.0_linux_amd64
...
./uptime-phoenix-worker_0.1.0_linux_amd64
```
...
./uptime-phoenix-config_0.1.0_linux_amd64 --help

# Kuma import helper
./uptime-phoenix-kuma-import_0.1.0_linux_amd64 --help
```
