...
Release: [v0.3.3](https://github.com/fiztoz/uptime-phoenix/releases/tag/v0.3.3)
...
### Download example (Linux amd64, v0.3.3)
...
./uptime-phoenix-api_0.3.3_linux_amd64
...
./uptime-phoenix-worker_0.3.3_linux_amd64
```
...
./uptime-phoenix-config_0.3.3_linux_amd64 --help

# Kuma import helper
./uptime-phoenix-kuma-import_0.3.3_linux_amd64 --help
```
