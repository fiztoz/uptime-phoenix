...
Deploy **Uptime Phoenix** with the published Helm chart (`v0.3.3+`).
...
| App image | `ghcr.io/fiztoz/uptime-phoenix:0.3.3` (empty `image.tag` → `Chart.AppVersion`) |
| Release assets | [v0.3.3](https://github.com/fiztoz/uptime-phoenix/releases/tag/v0.3.3) |
...
```bash
helm show chart oci://ghcr.io/fiztoz/charts/uptime-phoenix --version 0.3.3
helm show values oci://ghcr.io/fiztoz/charts/uptime-phoenix --version 0.3.3
...
curl -fsSL -o uptime-phoenix-0.3.3.tgz \
  https://github.com/fiztoz/uptime-phoenix/releases/download/v0.3.3/uptime-phoenix-0.3.3.tgz
helm upgrade --install uptime-phoenix ./uptime-phoenix-0.3.3.tgz \
