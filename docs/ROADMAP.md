...
**Next Focus:** owner decisions (`Monitor.Weight`, Thai review, publish). F3.4 ACME remains
on hold. Optional: reverse escalation-policy UI, config-as-code CLI helper.
