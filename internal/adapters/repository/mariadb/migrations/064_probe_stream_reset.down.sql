-- MariaDB DDL autocommits. Check every provenance guard before destructive DDL.
DROP TEMPORARY TABLE IF EXISTS probe_reset_downgrade_guard;
CREATE TEMPORARY TABLE probe_reset_downgrade_guard (ok INTEGER NOT NULL CHECK (ok = 1));
...
DROP TEMPORARY TABLE probe_reset_downgrade_guard;
