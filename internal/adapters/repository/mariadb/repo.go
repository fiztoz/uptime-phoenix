...
// NotificationTemplateRepo is the MariaDB-backed reusable message-template store.
type NotificationTemplateRepo struct{ db *bun.DB }

// NewNotificationTemplateRepo creates a MariaDB-backed notification-template repository.
