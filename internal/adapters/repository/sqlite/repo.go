...
// monitor. Delegated to the shared UNION ALL LIMIT 1 helper so the SQLite and
// MariaDB adapters cannot drift — see that function for why LIMIT 1 per monitor
// replaced the full-history scan.
