...
type ProbeConnectionTransport interface {
	...
	Run(ctx context.Context, input domain.ProbeSessionInput, established func(context.Context) error, applied func(context.Context, domain.ProbeActiveConfig) error) error
}
